...
SELECT inserted_shit.id, inserted_shit.created_at, inserted_shit.updated_at, inserted_shit.user_id, inserted_shit.feed_id, feeds.name AS feed_name, users.name AS user_name
FROM inserted_shit
INNER JOIN users
